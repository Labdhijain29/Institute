...
export const ROLE_PERMISSIONS = {
  ...
  Manager: ["leads:*", "receipts:*", "certificates:*", "offers:*", "payments:read", "students:read", "courses:read", "reports:read", "attendance:read", "leaves:read", "tasks:*", "demos:*", "notices:read"],
  HR: ["staff:*", "attendance:*", "salary:*", "leaves:*", "reports:read", "lectures:read", "tasks:read", "notices:read"],
  Telecaller: ["leads:create", "leads:read", "leads:update", "leads:forward", "followups:*", "courses:read", "attendance:read", "leaves:create", "leaves:read", "notices:read"],
  ...
  Receptionist: ["leads:create", "leads:read", "courses:read", "demos:create", "visitors:*", "attendance:read", "leaves:create", "leaves:read", "notices:read"],
